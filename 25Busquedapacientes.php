        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Formulario culeivin</h5>
                ...
                <div class="modal-body">
                    ...
                    <label id="tos" name="tos">Tos</label> <br>
                    <input type="checkbox" for="tos"> <br>

                    <label id="tos" name="tos">fiebre</label> <br>
                    <input type="checkbox" for="tos"> <br>

                    <label id="tos" name="tos">Disnea</label> <br>
                    <input type="checkbox" for="tos"> <br>
